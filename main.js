;(function (window) {
  ...
  let texts = ['HEY SAYANGGGGG','PENCET APA AJA YA BUAT NEXTTT', 'PAKE LANDSCAPE MODE YA', 'HEY SAYANGGGG', 'HAPPY VALENTINES DAY SAYANGKU', 'SEMOGA U SUKAAA', 'Ga kerasa ya udah setaun hehe', 'Udah banyak banget memories baru', 'Sayang thankyou ya selalu ada disini', 'Thankyou selalu sabar and selalu setia sama aku', 'Ur the best girlfriend everrr', 'always sticking by me through everything', 'Thankyou juga selalu ingetin aku makan', 'Everyday always feels like heaven thanks to you', 'I LOVE YOU SO VERY MUCH SAYANGGGG', 'My girlfriend', 'My princess', 'My soulmate', 'Ur the best sayang', 'HAPPY VALENTINES DAY MY LOVEEEE', 'YAUDAH DEHHHHHHH', 'I', 'LOVE', 'YOU ♡', 'ME AND YOU TOGETHER FOREVERRR', 'THANKYOU SYANGGGG', 'HOPE U LIKE ITTT', 'i love uuuuu']
